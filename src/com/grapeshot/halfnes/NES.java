...
import com.grapeshot.halfnes.net.LANManager; //TODO


/**
 *
 * @author Andrew Hoffman, Étienne B. Auger
 */
public class NES {
    ...
    final public static String VERSION = "v.058-LAN";
    ...
    public void run() {
        while (true) {
            if (runEmulation) {
                ...
                if (isLAN) { //juste une ligne de code a modifier
                    frame++;
                    if (frame == MAXFRAME){
                        frame = 0;
                    }
